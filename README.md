...
![AI Explanations](https://img.shields.io/badge/AI_Explanations-D97757?style=flat-square&logo=anthropic&logoColor=white) &nbsp; Claude-powered explanations help students understand the concept behind each topic.
...
| AI | Claude (Anthropic SDK) for concept explanations |
...
| `EXPLAIN_MODEL` | optional | Override the Claude model used for explanations |
...
Built with the help of an AI coding assistant. **All generated code was reviewed,
tested (`npm run build` passes), and is owned and understood by me** — see
`BLUEPRINT.md` for the full plan, sitemap, and page templates.
